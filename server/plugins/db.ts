...
const runContentMigrations = runMigrations(
  [
    ...
    {
      version: 48,
      sql: `CREATE TABLE IF NOT EXISTS tweet_drafts (
      id TEXT PRIMARY KEY,
      owner_email TEXT NOT NULL DEFAULT 'local@localhost',
      ...
      created_at TEXT NOT NULL DEFAULT (datetime('now'))
        ...
        CREATE INDEX IF NOT EXISTS tweet_drafts_owner_idx ON tweet_drafts (owner_email, created_at)`,
    },
    {
      version: 49,
      sql: `ALTER TABLE tweet_drafts ADD COLUMN IF NOT EXISTS kind TEXT NOT NULL DEFAULT 'short';
        ALTER TABLE tweet_drafts ADD COLUMN IF NOT EXISTS segments TEXT`,
    },
    {
      version: 50,
      sql: `CREATE TABLE IF NOT EXISTS operator_profile (
